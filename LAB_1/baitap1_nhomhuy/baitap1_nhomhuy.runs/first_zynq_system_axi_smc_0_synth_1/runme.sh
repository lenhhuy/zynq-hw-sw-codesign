...
HD_PWD='D:/Semester 6/Zynq_practical/baitap1_nhomhuy/baitap1_nhomhuy.runs/first_zynq_system_axi_smc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log first_zynq_system_axi_smc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source first_zynq_system_axi_smc_0.tcl
