...
extern "C"
void apatb_matrix_mult_hw(void* __xlx_apatb_param_a, void* __xlx_apatb_param_b, void* __xlx_apatb_param_prod)
{
...
#ifdef POST_CHECK
#ifdef USE_BINARY_TV_FILE
    .reader = new hls::sim::Input(AUTOTB_TVOUT_PC_prod),
#else
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_prod),
#endif
#else
#ifdef USE_BINARY_TV_FILE
    .owriter = new hls::sim::Output(AUTOTB_TVOUT_prod),
#else
    .owriter = new hls::sim::Writer(AUTOTB_TVOUT_prod),
#endif
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_prod),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_prod),
#endif
#endif
    .hasWrite = { true },
    .max_nbytes = { 0 },
  };
  port2.param = { __xlx_apatb_param_prod };
  port2.mname = { "prod" };
  port2.nbytes = { 50 };
  ...
  try {
    ...
    matrix_mult_hw_stub_wrapper(__xlx_apatb_param_a, __xlx_apatb_param_b, __xlx_apatb_param_prod);
