...
HLS_SOURCES = ../../../../../solution2/matrix_mult_test.cpp ../../../../../solution2/matrix_mult.cpp
...
$(ObjDir)/matrix_mult_test.o: ../../../../../solution2/matrix_mult_test.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../../solution2/matrix_mult_test.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++17 ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/matrix_mult_test.d

$(ObjDir)/matrix_mult.o: ../../../../../solution2/matrix_mult.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../../solution2/matrix_mult.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++17 ${CCFLAG} -c -MMD  -fhls-csim -fhlstoplevel=matrix_mult $(IFLAG) $(DFLAG) $< -o $@ ; \
