...
`ifndef MATRIX_MULT_REFERENCE_MODEL_SV
`define MATRIX_MULT_REFERENCE_MODEL_SV

class matrix_mult_reference_model extends uvm_component;
    ...
    `uvm_component_utils_begin(matrix_mult_reference_model)
