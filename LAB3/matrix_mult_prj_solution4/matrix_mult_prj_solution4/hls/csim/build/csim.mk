...
HLS_SOURCES = ../../../../../solution4/matrix_mult_test.cpp ../../../../../solution4/matrix_mult.cpp
...
$(ObjDir)/matrix_mult_test.o: ../../../../../solution4/matrix_mult_test.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../../solution4/matrix_mult_test.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++17 ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/matrix_mult_test.d

$(ObjDir)/matrix_mult.o: ../../../../../solution4/matrix_mult.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../../solution4/matrix_mult.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
