...
#ifndef _zynq_interrupt_system_xlconcat_0_0_core_h_
#define _zynq_interrupt_system_xlconcat_0_0_core_h_
...
class zynq_interrupt_system_xlconcat_0_0_core : public sc_module 
{
    public: 
       zynq_interrupt_system_xlconcat_0_0_core (sc_core::sc_module_name nm, const xsc::common_cpp::properties& props)
            : sc_module(nm)
              , In0    ( "In0" )
              , In1    ( "In1" )
              , dout   ( "dout" )
    {
        SC_HAS_PROCESS(zynq_interrupt_system_xlconcat_0_0_core);
    ...
    virtual ~zynq_interrupt_system_xlconcat_0_0_core() = default;
