...
HD_PWD='D:/Semester_6/HWSW/LAB2/zynq_interrupts/zynq_interrupts.runs/zynq_interrupt_system_axi_smc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zynq_interrupt_system_axi_smc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zynq_interrupt_system_axi_smc_0.tcl
