...
HLS_SOURCES = ../../../../../nco_test.cpp ../../../../../nco.cpp
...
$(ObjDir)/nco_test.o: ../../../../../nco_test.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../../nco_test.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++17 ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/nco_test.d

$(ObjDir)/nco.o: ../../../../../nco.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../../nco.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++17 ${CCFLAG} -c -MMD  -fhls-csim -fhlstoplevel=nco $(IFLAG) $(DFLAG) $< -o $@ ; \
