...
HD_PWD='D:/Semester_6/HWSW/LAB4/axi_counter_zybo/axi_counter_zybo.runs/system_rst_ps7_0_50M_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_rst_ps7_0_50M_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_rst_ps7_0_50M_2.tcl
