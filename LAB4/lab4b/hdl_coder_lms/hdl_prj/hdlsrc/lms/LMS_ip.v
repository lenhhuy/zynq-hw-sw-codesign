// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\lms\LMS_ip.v
...
module LMS_ip
  ...
  assign ip_timestamp = 32'b10011011010101001001000110111001;



  LMS_ip_dut u_LMS_ip_dut_inst (.clk(IPCORE_CLK),  // ufix1
                                .reset(reset),
  ...
  LMS_ip_reset_sync u_LMS_ip_reset_sync_inst (.clk(IPCORE_CLK),  // ufix1
                                              .reset_in(reset_before_sync),  // ufix1
                                              .reset_out(reset)
                                              );

  LMS_ip_cop u_LMS_ip_cop_inst (.clk(IPCORE_CLK),  // ufix1
                                .reset(reset),
  ...
  LMS_ip_axi_lite u_LMS_ip_axi_lite_inst (.reset(reset),
