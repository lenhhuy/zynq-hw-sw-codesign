...
//
//==============================================================
`ifndef MATRIX_MULT_SCOREBOARD__SV                                                       
    `define MATRIX_MULT_SCOREBOARD__SV                                                   
                                                                                               
                                                                                               
    class matrix_mult_scoreboard extends uvm_component;                                        
                                                                                               
        matrix_mult_reference_model refm;                                                      
                                                                                               
                                                                                               
        `uvm_component_utils_begin(matrix_mult_scoreboard)                                     
